...
public class ButtonMinMaxSlider extends Component {
    ...
    public ButtonMinMaxSlider(ModuleSettingDoubleSlider doubleSlider, ButtonModule module, int moduleStartY){
    ...
    public void draw(){
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.doubleSlider.getName() + ": " + this.doubleSlider.getInputMin() + ", " + this.doubleSlider.getInputMax(), (float)((int)((float)(this.module.category.getX() + 4) * 2.0F)), (float)((int)((float)(this.module.category.getY() + this.moduleStartY + 3) * 2.0F)), -1);
        GL11.glPopMatrix();
    }
