...
import keystrokesmod.sToNkS.module.modules.AutoConfig;
...
public class ButtonModule extends Component {
   ...
   public void draw() {
      ...
      Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.mod.getName(), (float)(this.category.getX() + this.category.getWidth() / 2 - Minecraft.getMinecraft().fontRenderer.getStringWidth(this.mod.getName()) / 2), (float)(this.category.getY() + this.o + 4), button_rgb);
      GL11.glPopMatrix();
