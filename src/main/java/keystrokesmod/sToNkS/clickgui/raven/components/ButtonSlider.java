...
public class ButtonSlider extends Component {
   ...
   public void draw() {
      ...
      Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.v.getName() + ": " + this.v.getInput(), (float)((int)((float)(this.p.category.getX() + 4) * 2.0F)), (float)((int)((float)(this.p.category.getY() + this.o + 3) * 2.0F)), -1);
      GL11.glPopMatrix();
   }
