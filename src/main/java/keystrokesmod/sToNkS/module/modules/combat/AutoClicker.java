...
import keystrokesmod.sToNkS.module.modules.player.FastPlace;
import keystrokesmod.sToNkS.tweaker.interfaces.IThrowableItem;
   ...
   public AutoClicker() {
      ...
      try {
         this.playerMouseInput = ReflectionHelper.findMethod(
                 GuiScreen.class,
                 "mouseClicked",
                 "func_73864_a", // TODO: idk need check it
                 Integer.TYPE,
                 Integer.TYPE,
                 Integer.TYPE
         );
