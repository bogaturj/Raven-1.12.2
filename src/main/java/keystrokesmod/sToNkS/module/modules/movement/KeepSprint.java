...
public class KeepSprint extends Module {
   ...
   public static void sl(Entity en) {
      ...
      if (c.isToggled() && reach != null && reach.isEnabled() && !mc.player.capabilities.isCreativeMode) {
         ...
         mc.player.motionX *= val;
         mc.player.motionZ *= val;
      } else {
         dist = (100.0D - (double)((float)b.getInput())) / 100.0D;
         mc.player.motionX *= dist;
         mc.player.motionZ *= dist;
      }
   }
}
