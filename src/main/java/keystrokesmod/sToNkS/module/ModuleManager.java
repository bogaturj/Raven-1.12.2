...
import keystrokesmod.sToNkS.module.modules.client.*;
import keystrokesmod.sToNkS.module.modules.combat.*;
import keystrokesmod.sToNkS.module.modules.debug.Click;
import keystrokesmod.sToNkS.module.modules.debug.MessageInfo;
import keystrokesmod.sToNkS.module.modules.debug.MouseClick;
import keystrokesmod.sToNkS.module.modules.fun.*;
import keystrokesmod.sToNkS.module.modules.hotkey.*;
import keystrokesmod.sToNkS.module.modules.minigames.*;
import keystrokesmod.sToNkS.module.modules.movement.*;
import keystrokesmod.sToNkS.module.modules.other.*;
import keystrokesmod.sToNkS.module.modules.player.*;
import keystrokesmod.sToNkS.module.modules.render.*;
import keystrokesmod.sToNkS.module.modules.world.AntiBot;
import keystrokesmod.sToNkS.module.modules.world.ChatLogger;
...
public class ModuleManager {
   ...
   public static void sort() {
      if (HUD.alphabeticalSort.isToggled()) {
         ...
         modsList.sort((o1, o2) -> Utils.mc.fontRenderer.getStringWidth(o2.getName()) - Utils.mc.fontRenderer.getStringWidth(o1.getName()));
      }
   ...
   public static void sortLongShort() {
      modsList.sort(Comparator.comparingInt(o2 -> Utils.mc.fontRenderer.getStringWidth(o2.getName())));
   }
