...
public class KeyStrokeMouse {
   ...
   public void n(int o, int p, int color) {
      ...
      this.b.fontRenderer.drawString(s, o + this.d + 8, p + this.e + 4, -16777216 + ((int)((double)t * j) << 16) + ((int)((double)u * j) << 8) + (int)((double)v * j));
      String w = mouseManager.getLeftClickCounter() + " CPS";
      String x = mouseManager.getRightClickCounter() + " CPS";
      int y = this.b.fontRenderer.getStringWidth(w);
      int z = this.b.fontRenderer.getStringWidth(x);
      boolean a2 = this.c == 0;
      int b2 = a2 ? y : z;
      GL11.glScalef(0.5F, 0.5F, 0.5F);
      this.b.fontRenderer.drawString(a2 ? w : x, (o + this.d + 17) * 2 - b2 / 2, (p + this.e + 14) * 2, -16777216 + ((int)(255.0D * j) << 16) + ((int)(255.0D * j) << 8) + (int)(255.0D * j));
